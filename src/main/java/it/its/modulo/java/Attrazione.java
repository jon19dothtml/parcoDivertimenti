...
public abstract class Attrazione {
    ...
    public Attrazione(String nomeAttrazione, String codiceAttrazione, Tipo tipoAttrazione,
                      int capacitaOraria, int altezzaMinimaCm, boolean aperta, AreaTematica areaTematica) {
    ...
    public boolean equals(Object obj) {
        ...
        if(obj instanceof Attrazione attrazione){
            return ((Attrazione) obj).getCodiceAttrazione().equals(this.getCodiceAttrazione());
        }
        return false;
    }
